...
execute as @e[type=marker,tag=smokeGrenade] at @s[tag=noteam] run function jjz:ability/steambomb/giveteam
execute as @e[type=marker,tag=smokeGrenade] at @s[tag=!noteam] run function jjz:ability/steambomb/inair
