...
execute if entity @s[tag=smoker] run scoreboard players set @s abilityTimer 38
execute if entity @s[tag=smoker] run item replace entity @s hotbar.2 with light_gray_dye 38
